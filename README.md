...
6. If you did everything correct, https://thrcorrea.github.io/teste-redoc/ will lead to your new docs
...
- Documentation(ReDoc): https://thrcorrea.github.io/teste-redoc/
- Look full spec:
    + JSON https://thrcorrea.github.io/teste-redoc/swagger.json
    + YAML https://thrcorrea.github.io/teste-redoc/swagger.yaml
- Preview spec version for branch `[branch]`: https://thrcorrea.github.io/teste-redoc/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://thrcorrea.github.io/teste-redoc/ with url from the message: `Server started <url>`
